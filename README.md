About typing-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/typing-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2102&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/typing-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `typing` can be installed with `conda`:
...
```
mamba install typing
```

It is possible to list all of the versions of `typing` available on your platform with `conda`:
...
```
mamba search typing --channel conda-forge
```
...
mamba repoquery search typing --channel conda-forge

# List packages depending on `typing`:
mamba repoquery whoneeds typing --channel conda-forge

# List dependencies of `typing`:
mamba repoquery depends typing --channel conda-forge
```
